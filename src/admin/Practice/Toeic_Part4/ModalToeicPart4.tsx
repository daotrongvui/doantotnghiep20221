...
import { Modal, FormInstance, Form, Row, Col, Input, Select, Button, message } from 'antd';
...
const { Option } = Select;
export default class ModalToeicPart4 extends BaseComponent<ModalToeicPart4Props, ModalToeicPart4State> {
    ...
    async saveItem() {
        ...
        try {
            ...
            if (this.state.item) {
                await toeicPart4Service.update('ToeicPart4', this.state.item.KeyDoc, itemSave);
            } else {
            ...
            >
                ...
                >
                    ...
                    <Row gutter={16}>
                        <Col span={12}>
                            <Form.Item labelCol={{ span: 24 }} label="Câu 1">
                                ...
                                <Form.Item
                                    ...
                                    rules={[{ required: true }]}
                                >
                                    <Select placeholder={'Chọn đáp án đúng'} style={{ width: '100%', marginLeft: 10 }}>
                        ...
                        <Col span={12}>
                            <Form.Item rules={[{ required: true }]} labelCol={{ span: 24 }} label="Câu 2">
                                <Form.Item labelCol={{ span: 6 }} label="Câu hỏi" name={'Question2'}>
                                    <TextArea style={{ marginLeft: 10 }} />
                                </Form.Item>
