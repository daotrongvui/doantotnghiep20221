...
export class NewEmployees extends BaseComponent<NewEmployeesProps, NewEmployeesStates> {
      ...
      const elements = this.state.dataSource.map((item, index) => {
        return (
          <div className={styles.newEmployeesSlider__slider__item}>
            {header}
            <div className={styles.newEmployeesSlider__slider__item__ContentInfor}>
              {item.PhotoUrl ? (
                <img
                  className={styles.newEmployeesSlider__slider__item__ContentInfor__Avartar}
                  src={`${item.PhotoUrl}?width=64&height=64`}
                />
              ) : (
                <img src={imgUser} className={styles.newEmployeesSlider__slider__item__ContentInfor__Avartar} />
              )}
              <div className={styles.newEmployeesSlider__slider__item__ContentInfor__employeeName}>
                {item.LoginName}
              </div>
              <div className={styles.newEmployeesSlider__slider__item__ContentInfor__jobtitleEmployee}>Học Sinh</div>
              <div className={styles.newEmployeesSlider__slider__item__ContentInfor__empMail}>Sinh viên năm cuối</div>
              <div className={styles.newEmployeesSlider__slider__item__ContentInfor__empPhone}>12/12/2022</div>
              <div
                onClick={() => {
                  window.location.href = `MSTeams:/l/chat/0/0?users=${item?.LoginName}`;
                }}
                className={styles.newEmployeesSlider__slider__item__ContentInfor__msTeam}
              >
                {iconMSTeam}
                Gửi tin nhắn
              </div>
  ...
  public render(): React.ReactElement<NewEmployeesProps> {
    const settings = this.getResponsiveSlider(this.state.dataSource.length) as any;
...
const header = (
  ...
  >
    ...
    <path
      ...
      fill="#FFA417"
    />
    <path d="M182.805 -3.8083L157.56 11.6753L160.103 8.53369L181.047 -6.9873L182.805 -3.8083Z" fill="#EDEDED" />
    <path d="M38.74 63.549L51.2316 63.0254L49.6234 63.6612L38.74 68.037V65.0824V63.549Z" fill="#D9D9D9" />
    <path d="M38.4033 63.0256L50.8949 62.502L49.3241 63.1377L38.4407 67.4762V64.559L38.4033 63.0256Z" fill="#FFA417" />
    <path d="M38.4033 63.0256L50.8949 62.502L49.3241 63.1377L38.4407 64.559L38.4033 63.0256Z" fill="#EDEDED" />
    <path
      d="M210.743 78.0602L202.552 73.834L203.786 73.9836L212.388 75.1804L211.304 77.0504L210.743 78.0602Z"
      fill="black"
    />
    <path d="M210.743 78.0602L202.552 73.834L203.786 73.9836L211.304 77.0504L210.743 78.0602Z" fill="black" />
    <path
    ...
    <path
      ...
      fill="#FF6F00"
    />
    <path d="M95.2513 -5.22949L110.174 10.9647L107.518 9.5435L93.1943 -3.47169L95.2513 -5.22949Z" fill="#D9D9D9" />
    <path
      d="M215.53 49.1497L198.887 48.4765L201.056 47.8033L216.016 43.2031L215.717 47.0927L215.53 49.1497Z"
      fill="#FF6F00"
    />
    <path d="M215.53 49.1498L198.887 48.4766L201.056 47.8034L215.717 47.0928L215.53 49.1498Z" fill="#D9D9D9" />
    <path
  ...
  return (
    ...
    >
      ...
      <path
        ...
        fill={'#FA541C'}
      />
      <rect x="0.5" y="0.5" width="23" height="23" rx="3.5" stroke={'#FA541C'} />
    </svg>
  );
}
