...
import { Modal, Button, Avatar, Divider, Input, Form, FormInstance, Spin, DatePicker, Select } from 'antd';
import styles from './UpdateInforUser.module.scss';
import { UserOutlined, MailOutlined, PhoneOutlined, WechatOutlined, CameraOutlined } from '@ant-design/icons';
...
export class ModalUpdateUser extends BaseComponent<UpdateInforProps, UpdateInforState> {
    public initialState = {
        modalVisible: false,
        edit: false,
        loading: false,
    ...
    async saveItem() {
        try {
            ...
            value.DateOfBirth = firebase.firestore.Timestamp.fromDate(value.DateOfBirth.toDate());

            if (this.state.item.KeyDoc) {
                await userInforService.update('MemberDirectory', this.state.item.KeyDoc, value);
            } else {
                ...
                await userInforService.update('MemberDirectory', result[0].KeyDoc as string, value);
            }
        ...
        return (
            ...
            >
                {this.state.modalVisible && (
                    <Spin spinning={this.state.loading} tip={'Loading'} style={{ height: '100%', width: '100%' }}>
                            ...
                            {this.state.edit ? (
                                <Form ref={this.formRef} style={{ width: '100%', marginTop: 20 }}>
                                    ...
                                    <Form.Item
                                        ...
                                        label="Công việc"
                                        name="JobTitle"
                                        rules={[{ required: true, message: 'Thiếu thông tin JobTitle!' }]}
                                    >
                                        <Input />
                                    </Form.Item>
                                    ...
                                    <Form.Item
                                        ...
                                        name="DateOfBirth"
                                        initialValue={moment()}
                                        rules={[{ required: true, message: 'Thiếu thông tin Ngày sinh!' }]}
                                    >
                                    ...
                                    <Form.Item
                                        ...
                                        rules={[{ required: true, message: 'Thiếu thông tin Ngày sinh!' }]}
                                    >
                                        <Select placeholder={'Chọn giới tính'} style={{ width: 150 }}>
                                            <Select.Option
                                                key={1}
                                                style={{ backgroundColor: '#e9ab17', color: 'white' }}
                                                value="Male"
                                            >
                                                Name
                                            </Select.Option>
                                    ...
                                    <Divider type={'horizontal'} style={{ backgroundColor: '#BFBFBF', height: 1.5 }} />
                                    <div className={styles.modalUpdateUser__otherInfor} style={{ height: 50 }}>
                                        <div className={styles.modalUpdateUser__otherInfor__title}>
                                            <MailOutlined style={{ marginRight: 5, color: '#007ACC' }} />
                                            Địa chỉ:
                                        </div>
                                    ...
                                    <div className={styles.modalUpdateUser__otherInfor} style={{ height: 50 }}>
                                        <a className={styles.modalUpdateUser__otherInfor__title}>
                                            <WechatOutlined style={{ marginRight: 3, color: '#007ACC' }} /> Bí danh
                                        </a>
                                    ...
                                    <div className={styles.modalUpdateUser__otherInfor} style={{ height: 50 }}>
                                        <div className={styles.modalUpdateUser__otherInfor__title}>
                                            <PhoneOutlined style={{ marginRight: 3, color: '#007ACC' }} /> Số điện
                                            thoại:
                                        </div>
                                    ...
                                    <div className={styles.modalUpdateUser__otherInfor} style={{ height: 50 }}>
                                        ...
                                        <Form.Item name="Email" rules={[{ message: 'Thiếu thông tin chat!' }]}>
                                            <Input style={{ width: 250 }} />
                                        </Form.Item>
                                    </div>

                                    {this.state.chageAvatar && (
                                        <div className={styles.modalUpdateUser__otherInfor} style={{ height: 100 }}>
                                            <div className={styles.modalUpdateUser__otherInfor__title}>
                                                <CameraOutlined style={{ marginRight: 5, color: '#007ACC' }} />
                                ...
                                <>
                                    <div className={styles.modalUpdateUser__LoginName}>{this.state.item.LoginName}</div>
                                    <div style={{ marginBottom: 5 }}>
                                        {this.state.item.JobTitle ? this.state.item.JobTitle : ''}
                                    </div>
                                    <div>{this.state.item.Address ? this.state.item.Address : ''}</div>
                                    <Divider type={'horizontal'} style={{ backgroundColor: '#BFBFBF', height: 1.5 }} />
                                    <div className={styles.modalUpdateUser__otherInfor}>
                                        <a
                                            ...
                                            className={styles.modalUpdateUser__otherInfor__title}
                                        >
                                            <WechatOutlined style={{ marginRight: 3, color: '#007ACC' }} /> Chat cùng
                                            tôi
                                        </a>
                                    </div>
                                    <div className={styles.modalUpdateUser__otherInfor}>
                                        <div className={styles.modalUpdateUser__otherInfor__title}>
                                            <PhoneOutlined style={{ marginRight: 3, color: '#007ACC' }} /> Tên khác:
                                        </div>
                                    ...
                                    <div className={styles.modalUpdateUser__otherInfor}>
                                        <div className={styles.modalUpdateUser__otherInfor__title}>
                                            <PhoneOutlined style={{ marginRight: 3, color: '#007ACC' }} /> Số Giới tính:
                                        </div>
                                        <a className={styles.modalUpdateUser__otherInfor__value}>
                                    ...
                                    <div className={styles.modalUpdateUser__otherInfor}>
                                        ...
                                        <a href="tel:123345" className={styles.modalUpdateUser__otherInfor__value}>
                                            {this.state.item.PhoneNumber ? this.state.item.PhoneNumber : ''}
                                        </a>
                                    </div>
                                    <div className={styles.modalUpdateUser__otherInfor}>
                                        <div className={styles.modalUpdateUser__otherInfor__title}>
