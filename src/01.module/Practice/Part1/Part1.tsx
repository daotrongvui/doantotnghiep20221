    ...
    return (
      <div className={styles.Part1Container}>
        <div className={styles.Part1Container__Content}>
          ...
          >
            <h1 style={{ color: '#dc143c', fontSize: 36 }}>Luyện Nghe TOEIC Part 1 : Mô tả hình ảnh</h1>
            <img
          ...
          <div className={styles.Part1Container__Content__introduce}>
            <p className={styles.Part1Container__Content__introduce__text_p}>
              Part 1&nbsp;của đề&nbsp;thi{' '}
              <a href="https://tienganhmoingay.com/de-thi-toeic/lam-de-thi-thu-toeic/" target="_blank">
                TOEIC
              </a>{' '}
              là một Phần Nghe&nbsp;(Listening) có tên gọi là Mô Tả Hình Ảnh&nbsp;(Photographs).&nbsp;
            </p>
            <p className={styles.Part1Container__Content__introduce__text_p}>
            ...
            <ol className={styles.Part1Container__Content__introduce__text_p}>
              <li className={styles.Part1Container__Content__introduce__text_li}>Bạn xem một bức hình</li>
              <li className={styles.Part1Container__Content__introduce__li}>
                Sau đó, bạn sẽ nghe 4 câu nói tương ứng với 4&nbsp;lựa chọn A, B,&nbsp;C, D
              </li>
              <li className={styles.Part1Container__Content__introduce__li}>
                Bạn sẽ chọn lựa chọn mà bạn cảm thấy là mô tả về bức hình đúng nhất
              </li>
            </ol>
            <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginBottom: 30 }}>
              Đây là phần thi được rất nhiều người{' '}
              <a href="https://tienganhmoingay.com/luyen-nghe-toeic/?r=luyen-nghe-toeic-part-1">luyện nghe TOEIC</a>
              &nbsp;yêu thích vì mỗi câu hỏi số lượng câu hỏi ít (đề thi format cũ là 10 câu và đề thi format
              mới&nbsp;từ ngày 01/6/2019 là 6 câu) và tương đối đơn giản.
            </p>
            <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginBottom: 30 }}>
              Tuy đơn giản như vậy nhưng cũng không nên chủ quan bạn nhé! Để làm tốt 6 câu này và giành được nhiều điểm
              nhất có thể,&nbsp;bạn chỉ cần học được cách trả lời cho 2 kiểu hình ảnh chính của Part 1 mà thôi. Sau khi
              học xong, bạn sẽ được củng cố những gì mình đã học qua 10&nbsp;bài tập luyện nghe TOEIC ngắn.
            </p>

            <p className={styles.Part1Container__Content__introduce__text_p}>Bắt đầu nào!</p>
          </div>

          <div className={styles.Part1Container__Content__tableOfContents}>
            <p className={styles.Part1Container__Content__introduce__text_p}>Mục lục:</p>
          ...
          <p className={styles.Part1Container__Content__introduce__text_p}>
            ...
            <a href="https://tienganhmoingay.com/de-thi-toeic/?r=luyen-nghe-toeic-part-1">đề thi TOEIC</a>. Nếu bạn học
            cách&nbsp;làm bài đối vói hình có con người là bạn đã làm tốt 70%~80% Part 1 luôn rồi đấy!
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p}>
          ...
          <ul className={styles.Part1Container__Content__ul}>
            ...
            <li>
              Người trong hình đang ở <strong>vị trí</strong> nào so với những vật và người xung quanh?
            </li>
          </ul>
          <h3 className={styles.Part1Container__Content__textBlue}>
            1.&nbsp;Người trong hình đang thực hiện <strong>hành động</strong> gì?
          </h3>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Khi luyện nghe TOEIC, có một số <strong>cấu trúc câu</strong>
            &nbsp;miêu tả hành động của con người mà bạn có thể nghe thấy trong các đáp án A B C D là:
          </p>
          <ul className={styles.Part1Container__Content__ul}>
            <li>
              <strong>CHỦ NGỮ</strong>&nbsp;+ is/are + <strong>V-ing</strong> = <strong>CHỦ NGỮ</strong> đang thực hiện{' '}
              <strong>HÀNH ĐỘNG (VERB)</strong>.<br></br>
              Ví dụ:
              <ul className={styles.Part1Container__Content__ul}>
                <li>The man is holding a ball in his hands. = Người đàn ông đang cầm quả bóng trong tay.</li>
                <li>The child is running towards the lake. = Đứa trẻ đang chạy về phía hồ nước.</li>
              </ul>
            </li>
            <li>
              There + is/are + <strong>CHỦ NGỮ</strong>&nbsp;+ <strong>V-ing</strong> = Có <strong>CHỦ NGỮ</strong> đang
              thực hiện hành động <strong>HÀNH ĐỘNG (VERB)</strong>.<br></br>
              Ví dụ:
              <ul className={styles.Part1Container__Content__ul}>
                <li>
                  There is a woman looking at the computer screen.&nbsp;= Có một người phụ nữ đang nhìn vào màn hình máy
                  tính.
                </li>
                <li>There are two men reading books. = Có hai người đàn ông đang đọc sách.</li>
              </ul>
            </li>
          </ul>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Như bạn có thể thấy, hành động đang thực hiện lúc nào cũng ở dạng <strong>V-ing</strong>, vì vậy các động từ
            chỉ hành động dưới đây đều sẽ được ghi ở dạng <strong>V-ing</strong> để bạn dễ ghi nhớ luôn nhé!
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p}>Ví dụ về sai chủ ngữ:</p>
          <img
            width={400}
            height={266}
            src={
          ...
          />
          <p style={{ marginLeft: 40 }} className={styles.Part1Container__Content__introduce__text_p}>
            Bạn có thể nghe&nbsp;lựa chọn sau:&nbsp;
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginLeft: 80 }}>
            <em>There's a woman standing in the picture. = Có một người phụ nữ đang đứng trong hình.</em>
          </p>
          <p style={{ marginLeft: 40 }} className={styles.Part1Container__Content__introduce__text_p}>
            =&gt; Lựa chọn&nbsp;trên là sai bởi vì trong hình này người đang đứng duy nhất là một người đàn ông, tất cả
            người phụ nữ trong hình đều đang ngồi.
          </p>
          ...
          <p style={{ marginLeft: 40 }} className={styles.Part1Container__Content__introduce__text_p}>
            =&gt; Lựa chọn trên là sai bởi vì đúng là trong hình có người đàn ông, nhưng người này đang chơi đá bóng chứ
            không phải nhảy múa.
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            <a id="hanh-dong-con-nguoi"></a>Cách tốt nhất để học về các <strong>hành động</strong> của con người là{' '}
            <strong>học động từ chỉ&nbsp;hành động</strong> theo&nbsp;từng bộ phận trên cơ thể. Dưới đây là các từ vựng
            TOEIC Part 1 mà các bạn cần chú ý:
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p}>
          ...
          ></img>
          <ul className={styles.Part1Container__Content__ul} style={{ marginTop: 15 }}>
            <li>
          ...
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginTop: 20, marginBottom: 20 }}>
            Từ vựng TOEIC Part 1 thiết yếu cũng khá nhiều phải không nào? Vì vậy, bạn cứ tranh thủ học dần để nhớ lâu
            hơn nhé!
          </p>
          <h3 className={styles.Part1Container__Content__textBlue}>
            2. Người trong hình đang ở <strong>vị trí</strong> nào so với những vật và người xung quanh?
          </h3>
          ...
          <ul className={styles.Part1Container__Content__ul}>
            <li>
              ...
              Ví dụ:
              <ul className={styles.Part1Container__Content__ul}>
                <li>The woman is on the left side of the road. = Người phụ nữ đang ở bên trái đường.</li>
              </ul>
            </li>
            <li>
              There + is/are + <strong>CHỦ NGỮ</strong> + <strong>GIỚI TỪ</strong>&nbsp;+ <strong>VẬT/NGƯỜI</strong>{' '}
              =&nbsp;Có&nbsp;<strong>CHỦ NGỮ</strong>&nbsp;ở...<br></br>
              Ví dụ:&nbsp;
              <ul className={styles.Part1Container__Content__ul}>
                <li>There is a woman across the street. = Có một người phụ nữ ở bên kia đường.</li>
                <li>There is a man at the bus stop. = Có một người đàn ông ở trạm xe buýt.</li>
              </ul>
            </li>
            <li>
              <strong>CHỦ NGỮ</strong>&nbsp;+ is/are + <strong>V-ing</strong> + <strong>GIỚI TỪ</strong>&nbsp;+{' '}
              <strong>VẬT/NGƯỜI</strong> = <strong>CHỦ NGỮ&nbsp;</strong>đang thực hiện{' '}
              <strong>HÀNH ĐỘNG (VERB)</strong>
              <strong> </strong>ở...<br></br>
              Ví dụ:
              <ul>
                <li>The child is sitting on the grass. = Đứa bé đang ngồi ở trên thảm cỏ.</li>
                <li>A woman is standing behind the man. = Một người phụ nữ đang đứng sau lưng người đàn ông.</li>
              </ul>
            </li>
            <li>
              There + is/are + <strong>CHỦ NGỮ</strong>&nbsp;+
              <strong> V-ing</strong>&nbsp;+ <strong>GIỚI TỪ&nbsp;</strong>+ <strong>VẬT NGƯỜI </strong>= Có{' '}
              <strong>CHỦ NGỮ</strong>&nbsp;đang thực hiện <strong>HÀNH ĐỘNG (VERB)​</strong>
              <strong> </strong>ở...<br></br>
              Ví dụ:
              <ul className={styles.Part1Container__Content__ul}>
                <li>There are three men running on the field. = Có ba người đàn ông đang chạy trên sân bóng.</li>
                <li>There is a woman swimming in the pool. = Có một người phụ nữ đang bơi trong bể bơi.</li>
              </ul>
            </li>
          </ul>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            <strong>Để chọn được đáp án đúng</strong>, bạn cần nghe kỹ về vị trí&nbsp;của người trong hình. Bên cạnh đó,
            nếu lựa chọn có nhắc đến hành động của người trong hình thì bạn cũng nên cẩn thận để không chọn sai, vì nếu
            vị trí đúng rồi mà hành động sai thì lựa chọn đó cũng sai.
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginLeft: 40 }}>
            <em>Ví dụ về sai động từ:</em>
          ...
          <p className={styles.Part1Container__Content__introduce__text_p}>Bạn có thể nghe một lựa chọn sau:</p>
          <p style={{ marginLeft: 80 }} className={styles.Part1Container__Content__introduce__text_p}>
            Bạn có thể nghe một lựa chọn sau:
            <em>The man is sitting on the football field. = Người đàn ông đang ngồi trên sân bóng đá.</em>
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginLeft: 40 }}>
            =&gt; Lựa chọn trên là sai bởi vì đúng là trong hình có sân bóng đá, nhưng người đàn ông đang đá bóng chứ
            không ngồi.
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginLeft: 40 }}>
          ...
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginLeft: 80 }}>
            <em>A man is standing on the desk. = Một người đàn ông đang đứng trên bàn.</em>
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginLeft: 40 }}>
            =&gt; Lựa chọn&nbsp;trên là sai bởi vì trong hình này có người đàn ông đang đứng, nhưng là đứng bên cạnh cái
            bàn, chứ không đứng trên bàn.
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            <strong>Vị trí của người trong hình</strong> sẽ được xác định bằng các giới từ chỉ nơi chốn, vì vậy bạn nhất
            định phải&nbsp;
            <strong>
              học một số <a href="https://tienganhmoingay.com/ngu-phap-toeic/chu-de-preps/">giới từ</a> về nơi chốn
            </strong>{' '}
            quan trọng sau đây:
          </p>
          <ul className={styles.Part1Container__Content__ul}>
          ...
          />
          <h2 data-id="side-label-index-3" className={styles.Part1Container__Content__textGreen}>
            <a id="vat"></a>2. Hình chỉ có vật mà không có người
          </h2>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Hình chỉ có vật mà không có người&nbsp;chiếm khoảng 20% - 30%&nbsp;câu hỏi trong Part 1 của đề thi TOEIC.
            Đối với loại hình ảnh này, khi xem hình, bạn nên xác định ngay&nbsp;những chi tiết sau:
          </p>
          <ul className={styles.Part1Container__Content__ul}>
            <li>
            ...
            <li>
              Những vật trong hình có <strong>vị trí </strong>như thế nào với nhau?
            </li>
          </ul>

          <h3 className={styles.Part1Container__Content__textBlue} data-id="side-label-index-4">
            1. <strong>Có những vật gì </strong>đáng chú ý trong hình?
          </h3>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Toeic sinh viên HUST xin cung cấp cho bạn 40 từ vựng về vật dụng thường xuyên xuất hiện nhất trong Part 1
            của đề thi TOEIC.
          </p>
          <ul className={styles.Part1Container__Content__ul}>
            <li>
          ...
          <h3 data-id="side-label-index-5" className={styles.Part1Container__Content__textBlue}>
            2.&nbsp;Những vật trong hình đang ở trong
            <strong> trạng thái gì</strong>?
          </h3>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Một số <strong>cấu trúc câu</strong>&nbsp;miêu tả trạng thái của các vật trong hình&nbsp;mà bạn có thể nghe
            thấy trong các đáp án A B C D là:
          </p>
          <ul className={styles.Part1Container__Content__ul}>
            <li>
              <strong>CHỦ NGỮ</strong> + is/are&nbsp;+ <strong>TÍNH TỪ</strong> = <strong>CHỦ NGỮ</strong> thì{' '}
            ...
            <li>
              <strong>CHỦ NGỮ </strong>+ look(s)/appear(s) + <strong>TÍNH TỪ </strong>=&nbsp;<strong>CHỦ NGỮ</strong>
              &nbsp;trông có vẻ <strong>TÍNH TỪ</strong>
              <br></br>
              Ví dụ:
              <ul className={styles.Part1Container__Content__ul}>
                <li>The books on the shelf&nbsp;look old. = Những quyển sách trên kệ trông có vẻ cũ kỹ.</li>
                <li>All the seats appear to be full. = Tất cả chỗ ngồi có vẻ đã kín hết.</li>
              </ul>
            </li>
            <li>
              <strong>CHỦ NGỮ</strong> + have/has + been +<strong> V3</strong> = <strong>CHỦ NGỮ</strong> đã được/bị{' '}
              <strong>VERB</strong>
              <br></br>
              Ví dụ:
              <ul className={styles.Part1Container__Content__ul}>
                <li>The door has been closed. = Cái cửa đã được đóng lại.</li>
                <li>The chairs have been stacked up. = Những cái ghế đã được xếp chồng lên.</li>
              </ul>
            </li>
          </ul>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            <strong>Để chọn được đáp án đúng</strong>, bạn cần xem xem chủ ngữ và tính từ&nbsp;có miêu tả đúng bức hình
            không. Nếu đúng cả 2 thứ thì chọn, còn nếu sai 1 trong 2 thì không chọn.
          </p>
          <p style={{ marginLeft: 40 }} className={styles.Part1Container__Content__introduce__text_p}>
          ...
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginLeft: 80 }}>
            <em>The desktop computer is turned on. = Máy tính để bàn đang bật.</em>
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p} style={{ marginLeft: 40 }}>
          ...
          <p className={styles.Part1Container__Content__introduce__text_p}>
            ...
            : đối với&nbsp;các&nbsp;câu hỏi hình ảnh&nbsp;KHÔNG&nbsp;có con người, tất cả&nbsp;các đáp án&nbsp;dạng "CHỦ
            NGỮ + are/is + <strong>being</strong> + V3" là SAI hết, ví dụ:
          </p>
          <ul className={styles.Part1Container__Content__ul}>
            <li>
              The room is <strong>being</strong> painted. = Căn phòng đang được sơn.
            </li>
            <li>
              A graph is <strong>being</strong> drawn on the board. = Một biểu đồ đang được vẽ trên bảng.
            </li>
            <li>
              The documents are <strong>being</strong> organized. = Các tài liệu đang được sắp xếp ngăn nắp.
            </li>
            <li>
          ...
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Vì sao những câu này chắc chắn sai?&nbsp;Bởi vì "being + V3" diễn tả một hành động đang xảy ra với một vật
            do sự tác động của con người, mà trong một bức hình không có con người thì không thể nào có hành động gì
            đang diễn ra được. Mẹo này rất hữu ích đúng không nào!
          </p>
          <h3 data-id="side-label-index-6" className={styles.Part1Container__Content__textBlue}>
            3. Những vật trong hình có <strong>vị trí </strong>như thế nào với nhau?
          </h3>
          <p className={styles.Part1Container__Content__introduce__text_p}>
          ...
          <ul>
            <li>
              CHỦ NGỮ&nbsp;+ is/are + GIỚI TỪ&nbsp;+ VẬT/NGƯỜI = CHỦ NGỮ&nbsp;đang ở...<br></br>
              Ví dụ:
              <ul>
                <li>A lamp is under the chair. = Cái đèn ngủ đang ở dưới cái ghế.</li>
                <li>The candles are on the table. = Những cái nến đang ở trên bàn.</li>
              </ul>
            </li>
            <li>
              There + is/are + CHỦ NGỮ + GIỚI TỪ&nbsp;+ VẬT/NGƯỜI =&nbsp;Có&nbsp;CHỦ NGỮ&nbsp;ở...<br></br>
              Ví dụ:&nbsp;
              <ul className={styles.Part1Container__Content__ul}>
                <li>There is a spoon in the sink. = Có một cái thìa ở trong bồn rửa.</li>
                <li>There are some paper on the floor. = Có vài tờ giấy ở dưới&nbsp;sàn nhà.</li>
              </ul>
            </li>
          </ul>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Cũng như khi xác định vị trí của người trong hình, <strong>vị trí của vật&nbsp;trong hình</strong> sẽ được
            xác định bằng các giới từ chỉ nơi chốn, vì vậy bạn nhất định phải&nbsp;
          ...
          />
          <h2 data-id="side-label-index-7" className={styles.Part1Container__Content__textGreen}>
            <a id="bai-tap"></a>3. Bài tập luyện nghe Part 1
          </h2>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Như vậy là bạn vừa học xong cách chọn đáp án cho 2 loại hình ảnh phổ biến nhất&nbsp;trong Part 1&nbsp;của đề
            thi TOEIC&nbsp;rồi.
          </p>
          <p className={styles.Part1Container__Content__introduce__text_p}>
            Bây giờ bạn&nbsp;hãy thử sức với <strong>10&nbsp;bài tập Part 1</strong>&nbsp;ngay dưới&nbsp;đây nhé:&nbsp;
          </p>
          <p>
            <a className={styles.Part1Container__Content__button} title="Làm bài tập Phần 2">
              Làm bài tập Part 1
            </a>
          </p>
          <CommentComp colectionName={'CommentPart1'} colectionReaction={'Part1_RC'} />
        </div>
        <Footer />
      </div>
    );
